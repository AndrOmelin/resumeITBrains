  ...
  res.render('task21', {
    ...
    nested_display: {
      ...
      children_display: {
        ...
        text: 'tags that have been identified as deprecated and not recommended for use in HTML v.5',
        button: {
          text: 'Орen',
        },
      },
...
router.get('/shopprofile', function (req, res) {
  ...
  res.render('shopprofile', {
    ...
    purchase: {
      ...
      itemList: [
        {
          number: '№12587461 від 01.01.2023',
          status: 'Виконано',
          amount: { title: 'Сума', value: '15 000 ₴' },
        ...
        {
          number: '№12587462 від 01.02.2023',
          status: 'Виконано',
        ...
        {
          number: '№12587464 від 01.03.2023',
          status: 'Виконано',
          amount: { title: 'Сума', value: '35 000 ₴' },
          images: [
            'https://picsum.photos/110/100',
            'https://picsum.photos/110/100',
          ],
